...
const socialLinks = [
  ...
  },
  {
    ...
    subText: "@frdddd._",
    icon: Instagram,
    url: "https://instagram.com/frdddd._/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@FaridRama",
    icon: Github,
    url: "https://github.com/FaridRama",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@fariiidd_11",
    color: "black",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
        ...
        data-aos="fade-down" 
      >
        <span className="inline-block w-8 h-1 bg-slate-500 rounded-full"></span>
        Connect With Me
      </h3>
