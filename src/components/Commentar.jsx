            ...
            {comment.profile_image ? (
                <img
                    ...
                    className={`w-10 h-10 rounded-full object-cover border-2 flex-shrink-0  ${
                        isPinned ? 'border-slate-500/50' : 'border-slate-500/30'
                    }`}
                    loading="lazy"
                />
            ) : (
                <div className={`p-2 rounded-full text-slate-400 group-hover:bg-slate-500/30 transition-colors ${
                    isPinned ? 'bg-slate-500/30' : 'bg-slate-500/20'
                }`}>
                ...
                <div className="flex items-center justify-between gap-4 mb-2">
                    <div className="flex items-center gap-2">
                        <h4 className={`font-medium truncate ${
                            isPinned ? 'text-slate-200' : 'text-white'
                        }`}>
                            {comment.user_name}
                        </h4>
                        {isPinned && (
                            <span className="px-2 py-0.5 text-xs bg-slate-500/20 text-slate-300 rounded-full">
                                Admin
                            </span>
                        )}
                    </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                ...
                <input
                    ...
                    className="w-full p-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-500/20 transition-all"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                ...
                <textarea
                    ...
                    className="w-full p-4 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-500/20 transition-all resize-none min-h-[120px]"
                    required
                />
            </div>
                    ...
                    {imagePreview ? (
                        <div className="flex items-center gap-4">
                            <img
                                src={imagePreview}
                                alt="Profile preview"
                                className="w-16 h-16 rounded-full object-cover border-2 border-slate-500/50"
                            />
                            <button
                                type="button"
                                onClick={() => {
                        ...
                        <div className="w-full">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-slate-500/20 text-slate-400 hover:bg-slate-500/30 transition-all border border-dashed border-slate-500/50 hover:border-slate-500 group"
                            >
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r  from-gray-600 to-white rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
            ...
            <div className="p-6 border-b border-white/10" data-aos="fade-down" data-aos-duration="800">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-white">
                        Comments <span className="text-slate-400">({totalComments})</span>
                    </h3>
                </div>
            </div>
                ...
                <div className="space-y-4 h-[328px] overflow-y-auto overflow-x-hidden custom-scrollbar pt-1 pr-1 " data-aos="fade-up" data-aos-delay="200">
                    ...
                    {comments.length === 0 && !pinnedComment ? (
                        <div className="text-center py-8" data-aos="fade-in">
                            <UserCircle2 className="w-12 h-12 text-slate-400 mx-auto mb-3 opacity-50" />
