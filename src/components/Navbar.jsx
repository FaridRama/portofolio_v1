            ...
            <div className="ml-8 flex items-center space-x-8">
              {navItems.map((item) => (
                ...
                >
                  <span
                    className={`relative z-10 transition-colors duration-300 ${
                      activeSection === item.href.substring(1)
                        ? "bg-gradient-to-r from-gray-400 to-white bg-clip-text text-transparent font-semibold"
                  ...
                  <span
                    className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-gray-400 to-white transform origin-left transition-transform duration-300 ${
                      activeSection === item.href.substring(1)
                        ? "scale-x-100"
