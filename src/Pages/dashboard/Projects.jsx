...
const Card = ({ children, className = "" }) => (
  <div className={`relative group ${className}`}>
    <div className="absolute -inset-0.5 bg-gradient-to-r from-gray-500 to-white rounded-2xl blur opacity-10 group-hover:opacity-25 transition duration-500" />
...
const InputField = ({
  ...
  <div className="space-y-1.5">
    ...
    <input
      ...
      required={required}
      className="w-full bg-[#000000] border border-white/10 rounded-xl px-4 py-2.5 text-gray-200 placeholder-gray-600 text-sm outline-none focus:border-white/40 focus:ring-1 focus:ring-white/20 transition-all"
    />
  </div>
);
...
const SkeletonCard = () => (
  <div className="relative">
    <div className="absolute -inset-0.5 bg-gradient-to-r from-gray-500 to-white rounded-2xl blur opacity-10" />
        ...
        {project.tech_stack?.length > 0 && (
          <div className="flex flex-wrap gap-1.5 mb-3">
            {project.tech_stack.map((t) => (
              <span
                key={t}
                className="px-2 py-0.5 rounded-full bg-white/10 border border-white/20 text-gray-300 text-xs"
              >
                {t}
              </span>
            ))}
        ...
        <div className="mt-auto flex items-center justify-between gap-2 pt-2 border-t border-white/8">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/20 text-white hover:bg-white/10 text-xs transition-colors"
            >
...
const Modal = ({ title, onClose, children }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
    ...
    >
      <div className="absolute -inset-0.5 bg-gradient-to-r from-gray-500 to-white rounded-2xl blur opacity-20 pointer-events-none" />
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="sm:col-span-2 space-y-1.5">
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-[#000000] border border-white/10 rounded-xl px-4 py-2.5 text-gray-200 placeholder-gray-600 text-sm outline-none focus:border-white/40 focus:ring-1 focus:ring-white/20 transition-all resize-none"
          />
        </div>
        ...
        <div className="sm:col-span-2 space-y-1.5">
          ...
          <label className="flex items-center gap-4 w-full bg-[#000000] border border-dashed border-white/15 rounded-xl px-4 py-4 cursor-pointer hover:border-white/40 hover:bg-white/4 transition-all">
            {preview ? (
              <img
                src={preview}
      ...
      <div className="flex justify-end gap-2 pt-1">
        ...
        <button type="submit" disabled={uploading} className="relative group/s">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-gray-600 to-white rounded-xl opacity-60 blur group-hover/s:opacity-100 transition duration-300" />
          <div className="relative flex items-center gap-2 px-5 py-2 bg-[#000000] rounded-xl border border-white/10">
            {uploading ? (
  ...
  return (
    <div className="space-y-6z ">
      ...
      <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
        ...
        >
          <div className="absolute -inset-0.5 bg-gradient-to-r from-gray-600 to-white rounded-xl opacity-50 blur group-hover:opacity-80 transition duration-300" />
          <div className="relative flex items-center gap-2 px-4 py-2.5 bg-[#000000] rounded-xl border border-white/10">
